...
<div class="story"> 
	...
	<p>
     <a href="http://www.swiss.com"onClick="window.open(this.href, '_blank','scrollbars=no,resizable=yes,toolbar=no,directories=no,location=yes,menubar=no,status=no,left=0,top=0');return false">Swiss</a>
   </p>
	<p>
     <a href="http://www.flybaboo.com/fr"target="_blank">Flybaboo</a> 
	</p>
	<p>
</div>
<div class="story"> 
	<h3>Location de voiture</h3>
	 <p>
	<a href="http://www.hispacar.com/location-voitures/"onClick="window.open(this.href, '_blank','scrollbars=no,resizable=yes,toolbar=no,directories=no,location=yes,menubar=no,status=no,left=0,top=0');return false">Hispacar</a>
	</p>
	<p>
	<a href="http://www.victoriacars.com/alquiler_coches.html"onClick="window.open(this.href, '_blank','scrollbars=no,resizable=yes,toolbar=no,directories=no,location=yes,menubar=no,status=no,left=0,top=0');return false">Victoria S.L.</a>
    </p>
	<p>
</div>
<div class="story"> 
...
<div class="story"> 
	...
	<p>
	<a href="http://www.aqualandia.net" target="_blank">Aqualandia, parc aquatique &agrave; Benidorm (es)</a>
	<p>
	<a href="http://www.mundomar.es"onClick="window.open(this.href, '_blank','scrollbars=no,resizable=yes,toolbar=no,directories=no,location=yes,menubar=no,status=no,left=0,top=0');return false">Mundomar, parc d'animaux aquatiques &agrave; c&ocirc;t&eacute; d'Aqualandia (es)</a>
	</p>
	<p>
	<a href="http://www.terramiticapark.com" target="_blank">Terra Mitica, l'europapark d'espagne vers Benidorm (es)</a>
	</p>
	<p>
...
<div class="story"> 
	<h3>Pratique</h3>
	<p>
	<a href="http://www.oanda.com/convert/classic?lang=fr"onClick="window.open(this.href, '_blank','scrollbars=no,resizable=yes,toolbar=no,directories=no,location=yes,menubar=no,status=no,left=0,top=0');return false">Convertisseur de monnaies</a>	    
    </p>
	<p>    
</div>
	</div>
<div class="story">
    <p align="center"> 
     <a href="http://www.espagne-vacances.ch/homepage_fr.php?content=11&PHPSESSID=907caa0edc9a54939e517d7c26216aa7"><img  src="meinebilder/top.GIF"alt="en haut" width="5%"></a>
	</p>
		 </li>
		</ul>
	</div>
