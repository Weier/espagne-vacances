 <div class="feature"> 
 	<a onclick="window.open(this.href, '_blank', 'width=840,height=742,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0');return false" href="http://maps.google.fr/maps?f=q&hl=fr&geocode=&q=Calpe&jsv=107&sll=47.15984,2.988281&sspn=15.42549,29.443359&ie=UTF8&ll=38.74016,0.044632&spn=0.276358,0.460052&t=p&z=11"><img  src="meinebilder/reiseweg.gif"alt="Trajet de voyage" border="0"></a>
	<h3>Comment arriver &agrave; Calpe ?</h3>
	<p>
	Il existe une multitude de possibilit&eacute;s pour se rendre &agrave; Calpe. Dans ce chapitre je vais vous donner un aper&ccedil;u des moyens de transports les plus souvent utilis&eacute;s.
	</p>
	</div> 
<div class="story"> 
	<h3>Avec la voiture</h3> 
	<p>
	Pour vous rendre de Lausanne &agrave; Calpe en voiture il vous faut parcourir 1400 km. Ceci repr&eacute;sente un trajet de plus ou moins 14 heures. Mis &agrave; part le prix de l'essence il faut aussi prendre en compte le prix des p&eacute;ages en France et en Espagne.
	<p> 
	Ce voyage co&ucirc;tera aux alentours de CHF 700.-
	<p>
</div>	 
<div class="story"> 
	<h3>Avec l'avion</h3> 
...
<div class="story"> 
	...
	<p>
	Les prix varient entre 100.- et 300.- par chemin.
	<p>
</div>  
<div class="story"> 
	<h3>Avec le train</h3> 
