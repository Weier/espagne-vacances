<div class="feature">
	<a href="meinebilder/maison_avec_piscine.jpg" onclick="window.open(this.href, '_blank','width=325,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0');return false"><img src="meinebilder/maison_avec_piscine_klein.jpg"alt="Hier wohnen Sie" width="20%" height="20%" border="0"></a>
	<h3>Das Haus</h3>
	<p>
    Das Ferienhaus besteht aus 2 Wohnungen, die aber nur auf Wunsch des Mieters gemeinsam vermietet werden. Dies gew&auml;hrleistet Ihnen einen ungest&ouml;rten Urlaub.
	<br>(Rauchverbot, Haustiere nach Absprache)
	</p> 
	<p>
	Eine Garage f�r 1 Auto steht Ihnen zur Verf&uuml;gung. Ein zweites Fahrzeug kann vor der Garage parkiert werden.
	</p> 
	<p>
	Im Garten steht neben dem Grill, unter einem grossen, schattenspendenden Baum, ein gem&uuml;tlicher, runder Steintisch.
	</p>
	<p>
	F&uuml;r die willkommene, sommerliche Erfrischung steht Ihnen ein 4x8 m grosses Schwimmbad zur Verf&uuml;gung.	 
    <br>
	<a href="Photogalerie/Das Haus/Rund ums Haus/index_de.html" onClick="window.open(this.href, '_blank','scrollbars=no,resizable=yes,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0');return false">Photos</a>
	</p>
</div>
<hr>
<div class="story">  
	    <a name="Die Hauptwohnung"><h3>Die Hauptwohnung</h3></a>
		<p>
	 (max. 5 Personen)
	</p> 
	<p>
	 <ul>
  		<li> 1 Doppelbettschlafzimmer</li>
		<li> 1 Schlafzimmer mit 2 Betten + 1 Notbett</li>
		<li> 1 grosses Badezimmer (Badewanne, WC und Bidet)</li>
		<li> 1 kleines Badezimmer (Dusche und WC)</li>
		<li> 1 Wohnzimmer mit Essecke und Chemin&eacute;e</li>
		<li> 1 K&uuml;che (Gasherd mit Ofen, K&uuml;hlschrank, Kaffeemaschine)</li>
		<li> 1 gedeckte, verglaste Wohnterrasse mit Blick aufs Meer</li>
		<li> 1 Sonnenterrasse</li>
	 </ul>
	</p> 
	<p>
		
		<a onclick="window.open(this.href, '_blank', 'width=2048,height=1536,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0');return false" href="Photogalerie/Das Haus/Im Haus/slides/129.JPG"><img  src="Photogalerie/Das Haus/Im Haus/slides/129.JPG"alt="K�che" width="40%"></a>
...
<div class="story"> 
	...
	<p>
  <ul>		
		<li> 1 Schlafzimmer mit 2 Betten</li>
		<li>1 Badezimmer (Dusche und WC)</li>
		<li>1 Wohnzimmer</li>
		<li>1 K&uuml;che</li>
  </ul>
	</p> 
	...
	<a onclick="window.open(this.href, '_blank', 'width=2048,height=1536,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0');return false" href="Photogalerie/Das Haus/Im Haus/slides/134.JPG"><img  src="Photogalerie/Das Haus/Im Haus/slides/134.JPG"alt="K�che" width="40%"></a>
